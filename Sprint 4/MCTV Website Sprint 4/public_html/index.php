      ...
      <div class="container">
        <div class="grid">
          <div class="grid__col grid__col--3-of-4 grid__col--centered">
            ...
            <input class="u-full-width" style="padding: 1.5em" placeholder="Email" class="input" type="text" name="" value="">
            <br><br>
            <input type="text" class="btn-primary input u-full-width" name="" value="Submit">
          </div>
        </div>
      </div>
    </div>
