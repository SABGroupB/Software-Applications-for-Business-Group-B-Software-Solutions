...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  echo "<p class=\"message u-text-center padding green white-text\">{$message}</p>";
...
include_once $_SERVER["DOCUMENT_ROOT"] . '/../inc/header.php';
 ...
 ?>
    ...
    <div class="newsletter lightgray white-text padding x4">
      <div class="container">
        <div class="grid">
          <div class="grid__col grid__col--3-of-4 grid__col--centered">
            ...
            <form class="" action="/index.php" method="POST">
              <input class="u-full-width" style="padding: 1.5em" placeholder="Email" class="input" type="email" name="email" value="">
              <input type="submit" class="btn-primary input u-full-width" name="" value="Submit">
              <br><br>
            </form>
          </div>
        </div>
