      ...
      <div class="container">
        <div class="grid">
          <div class="u-text-center grid__col grid__col--6-of-12">
            <img src="http://localhost:8080/img/tvs/tv-large1.jpg" alt="">
          </div>
        ...
        <div class="grid">
          <div class="grid__col grid__col--3-of-4 grid__col--centered">
            ...
            <form class="" action="index.html" method="GET">
              <input class="u-full-width" style="padding: 1.5em" placeholder="Email" class="input" type="text" name="email" value="">
